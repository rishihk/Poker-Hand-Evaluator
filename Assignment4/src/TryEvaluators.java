 ...
 * 
 * This code will not compile until parts of the hw4 package have been
 * implemented.
 */
public class TryEvaluators
{
	...
	public static void main(String[] args)
	{
		...
		OnePairEvaluator eval2 = new OnePairEvaluator(1, 2);
		eval2=eval;
		...
		// Card[] cards1 = {new Card(2, Suit.CLUBS), new Card(2, Suit.DIAMONDS), new
		// Card(4, Suit.SPADES), new Card(6, Suit.DIAMONDS)};
