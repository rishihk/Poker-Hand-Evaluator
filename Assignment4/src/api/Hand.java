...
/**
 * A Hand represents a collection of cards satisfying some criteria defined by
 * an instance of <code>IEvaluator</code>. A hand has zero or more <em>main
 * cards</em> that determine whether it satisfies the evaluator's criteria, plus
 * zero or more <em>side cards</em> that are irrelevant to the evaluator's
 * criteria but may be used to determine a winning hand when the main cards are
 * the same, disregarding suits.
 * 
...
public class Hand implements Comparable<Hand>
{
	...
	/**
	 * Constructs a new Hand from the given cards. The number of mainCards given
	 * must match the number of required cards specified by the given evaluator and
	 * the main card array must be ordered so that lexicographic comparison with
	 * another array satisfying the same evaluator will correctly order the hands.
	 * The number of side cards given must be sufficient to complete the total size
	 * of the hand as specified by the evaluator, and the side cards must be ordered
	 * according to the compareTo method of the Card class. It is the responsibility
	 * of the caller to ensure that the main cards satisfy the criteria of the
	 * evaluator.
	 * 
	 * @param mainCards main cards for the hand
	 * @param sideCards side cards for the hand
	 * @param evaluator reference to an IEvaluator whose criteria are satisfied by
	 *                  this hand
	 * @throws IllegalArgumentException if the number of main cards is incorrect or
	 *                                  the number of side cards is insufficient
	 */
	...
	/**
	 * Returns the ranking of this hand according to the evaluator used in its
	 * construction.
	 * 
	 * @return ranking of this hand
	 */
	...
	/**
	 * Returns the name of this hand according to the evaluator used in its
	 * construction.
	 * 
	 ...
	 * 
	 * @return main cards for this hand
	 */
	 ...
	 * 
	 * @return side cards for this hand
	 */
	...
	/**
	 * Lexicographically compares two arrays of cards having the same length,
	 * ignoring suits.
	 * 
	 * @param lhs
	 * @param rhs
